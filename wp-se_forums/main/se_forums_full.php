...
<tr>
<td width=\"8%\"><img src=\"{$socialdir}/images/forum/icon_topic.gif\" width=\"35\" height=\"35\" alt=\"\" /></td>
<td width=\"40%\" align=\"left\"><div style=\"{$titlestyle}\">{$mylink}{$shortdesc}</a><br />";
...
$rows .="</div><span style=\"{$statstyle}\">Created {$miovalore} by {$mylink3}{$mynome2}</a><br />Category &raquo; {$mylink2}{$row['titleX']}</a></span></td>
<td width=\"7%\" align=\"center\">{$row['cache_count_posts']}</td>
<td width=\"7%\" align=\"center\">{$row['cache_views']}</td>
<td width=\"8%\" align=\"left\">{$mylink1}{$mypic}{$btext}</td>
<td width=\"30%\" align=\"left\">{$right_text}</td>
</tr>
</table>
</td>
";
...
$content .="<table width=\"100%\" cellspacing=\"{$outer_cellspacing}\" cellpadding=\"{$outer_cellpadding}\" {$mymainstyle}><tr>";
$content .=" <td width=\"48%\" bgcolor=\"{$mainbox_bg_color}\" align=\"center\" style=\"{$statstyle}\">TOPIC</td><td width=\"7%\" bgcolor=\"{$mainbox_bg_color}\" align=\"center\" style=\"{$statstyle}\">REPLY</td><td width=\"7%\" bgcolor=\"{$mainbox_bg_color}\" align=\"center\" style=\"{$statstyle}\">VIEWS</td><td width=\"38%\" bgcolor=\"{$mainbox_bg_color}\" align=\"center\" style=\"{$statstyle}\">LAST POST</td></tr></table>";
$content .=" <table width=\"100%\" cellspacing=\"{$outer_cellspacing}\" cellpadding=\"{$outer_cellpadding}\" {$mymainstyle}><tr>";
$content .="{$rows}";
$content .="</tr></table>";

//if($mycase !=="0") {
$content .=" <table width=\"100%\" cellspacing=\"{$outer_cellspacing}\" cellpadding=\"{$outer_cellpadding}\" bgcolor=\"{$mainbox_bg_color}\">
			 <tr>
			 <td align=\"left\" valign=\"top\">
